...
func RegisterAllProcs() {
	...
	// https://www.wowhead.com/tbc/spell=22600
			...
			//	RequireDamageDealt: false
			// }, []shared.ItemVariant{
			//	{ItemID: 18168, ItemName: "Force Reactive Disk"},
			//	{ItemID: 18168, ItemName: "Force Reactive Disk"},
			// })
	...
	//       With next db run the item will be removed if implemented.
	//
	// Instantly increases your rage by 20.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Instantly increases your energy by 20.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Reduces the threat you generate by 50% for 20s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Reduces the threat you generate by 25% for 20s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// You are protected from all physical attacks for 6s, but cannot attack or use physical abilities.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Increases attack power by 65 and an additional 65 every 2.0 sec. Lasts 20s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Increases Stamina of nearby party members by 20 for 30min.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Restores 6 health per second to nearby party members for 30min.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Causes your Judgements to heal you for 49.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Reduces the cost of your next spell cast within 10s by up to 215 mana.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Water Shield ability grants an additional 27 mana each time it triggers and an additional 2 mana
	// per 5 sec.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Causes your Deadly Throw ability to interrupt spellcasting and prevent any spell in that school from being
	// cast for 3s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// 20% chance per combo point to heal yourself for 110 each time you land a finishing move.
	...
	//       With next db run the item will be removed if implemented.
	//
	// The next opponent you kill within 10s that yields experience or honor will restore 900 mana.
	...
	//       With next db run the item will be removed if implemented.
	//
	// The next opponent killed within 15s that yields experience or honor will restore 900 health.
	...
	// https://www.wowhead.com/tbc/spell=33504
			...
			//	RequireDamageDealt: false
			// }, []shared.ItemVariant{
			//	{ItemID: 27920, ItemName: "Mark of Conquest"},
			//	{ItemID: 27920, ItemName: "Mark of Conquest"},
	...
	//       With next db run the item will be removed if implemented.
	//
	// Chance on spell hit to restore 172 mana to the bearer.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Increases the melee attack power bonus of your Seal of the Crusader by 68 and the Holy damage increase
	// of your Judgement of the Crusader by 47.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Causes your Flash of Light to increase the target's Resilience rating by 26 for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Causes your Lesser Healing Wave to increase the target's Resilience rating by 26 for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your spell casts have a chance to allow 15% of your mana regeneration to continue while casting for 15s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Increases the benefit your Flash of Light spell receives from Blessing of Light by 60 and Holy Light spell
	// receives from Blessing of Light by 120.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Hurls your axe in an attempt to decapitate your target causing 567 damage.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Steals 315 life from target enemy.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Each healing spell you cast has a 2% chance to make your next heal cast within 15s cost 450 less mana.
	// https://www.wowhead.com/tbc/spell=0
			// shared.NewProcStatBonusEffectWithVariants(shared.ProcStatBonusEffect{
			//	Callback:           core.CallbackEmpty,
			//	ProcMask:           core.ProcMaskUnknown,
	...
	//       With next db run the item will be removed if implemented.
	//
	// Increases your movement speed by 50%, and your melee attack speed by 20% for 30s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Friendly targets of the caster's heals gain an effect that reduces the damage taken by Fire and Shadow
	// spells by 50% for 30s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your direct healing spells have a chance to place a heal over time on your target, healing 500 over 12s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your spells and attacks in each form have a chance to grant you a blessing for 15s.
	// https://www.wowhead.com/tbc/spell=0
			// shared.NewProcStatBonusEffectWithVariants(shared.ProcStatBonusEffect{
			//	Callback:           core.CallbackEmpty,
			//	ProcMask:           core.ProcMaskUnknown,
	...
	//       With next db run the item will be removed if implemented.
	//
	// You gain 25% more mana when you use a mana gem. In addition, using a mana gem grants you 225 spell damage
	// for 15s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your heals each cost 22 less mana for the next 15s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Mangle has a 40% chance to grant 140 Strength for 8s, Starfire has a 25% chance to grant up to 150 spell
	// damage for 8s, and Rejuvenation has a 25% chance to grant up to 210 healing for 8s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Each time your Shadow Word: Pain deals damage, it has a 10% chance to grant you 220 spell damage for 10s
	// and each time your Renew heals, it has a 10% chance to grant you 220 healing for 5s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Lesser Healing Wave has a 10% chance to grant 170 mana, Lightning Bolt has a 15% chance to grant up to
	// 170 mana, and Stormstrike has a 50% chance to grant up to 275 attack power for 10s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// 20% chance per combo point for your finishing moves to grant 145 critical strike rating for 10s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Causes your Flash of Light to increase the target's Resilience rating by 31 for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Causes your Lesser Healing Wave to increase the target's Resilience rating by 31 for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Holy Light spell grants 22 mana per 5 sec. for 30s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Increases the damage done by your Seal of Righteousness and Judgement of Righteousness abilities by up
	// to 94.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Shock spells have a chance to grant 110 attack power for 10s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Moonfire ability has a chance to grant up to 140 spell damage and healing for 10s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Causes your Flash of Light to increase the target's Resilience rating by 34 for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Causes your Lesser Healing Wave to increase the target's Resilience rating by 34 for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Judgement ability also grants you 26 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Judgement ability also grants you 31 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Judgement ability also grants you 34 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Stormstrike ability also grants you 26 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Stormstrike ability also grants you 31 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Stormstrike ability also grants you 34 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Moonfire ability also grants you 26 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Moonfire ability also grants you 31 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Moonfire ability also grants you 34 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Mangle ability also grants you 26 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Mangle ability also grants you 31 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Mangle ability also grants you 34 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Holy Shield ability also grants you 26 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Holy Shield ability also grants you 31 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Holy Shield ability also grants you 34 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Earth Shock, Flame Shock, and Frost Shock abilities also grant you 26 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Earth Shock, Flame Shock, and Frost Shock abilities also grant you 31 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Earth Shock, Flame Shock, and Frost Shock abilities also grant you 34 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Gain 250 mana each sec. for 8s. Channeled.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your heals have a chance to call on the power of the Arcane if you're exalted with the Scryers, or the
	// Light if you're exalted with the Aldor.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your spells have a chance to call on the power of the Arcane if you're exalted with the Scryers, or the
	// Light if you're exalted with the Aldor.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your melee and ranged attacks have a chance to call on the power of the Arcane if you're exalted with
	// the Scryers, or the Light if you're exalted with the Aldor.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Mangle ability also grants you 39 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Moonfire ability also grants you 39 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Judgement ability also grants you 39 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Causes your Flash of Light to increase the target's Resilience rating by 39 for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Holy Shield ability also grants you 39 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Stormstrike ability also grants you 39 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Your Earth Shock, Flame Shock, and Frost Shock abilities also grant you 39 resilience rating for 6s.
	...
	//       With next db run the item will be removed if implemented.
	//
	// Causes your Lesser Healing Wave to increase the target's Resilience rating by 39 for 6s.
